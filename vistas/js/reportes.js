...
if (localStorage.getItem("capturarRango2") != null) {
	...
	$("#daterang-btn2 span").html(localStorage.getItem("capturarRango2"));
}else{

	$("#daterang-btn2 span").html('<i class="far fa-calendar-alt"></i> Rango de fecha');
}
...
$('#daterang-btn2').daterangepicker(
  ...
  function (start, end) {
    $('#daterang-btn2 span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    var fechaInicial = start.format('YYYY-MM-DD');

    var fechaFinal = end.format('YYYY-MM-DD');

    var capturarRango2 = $("#daterang-btn2 span").html();
