...
$comentario =$respuestaVenta["comentario"];
$impuestos = number_format($respuestaVenta["impuestos"], 2);
     ...
     height="190"></td>
		...
		<tr>
			<td style="background-color:white; width:350px">
				<div style="font-size:10.5px; text-aling:right; line-heigth:15px">
			...
			<td style="background-color:white; width:150px">
				...
				<td style="background-color:white; width:60px text-align:center; color:red">
