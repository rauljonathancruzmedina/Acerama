  ...
  <section class="content">
    <div class="card">
      ...
      <div class="card-header">
        ...
        <button type="button" class="btn btn-success "  id="daterang-btn2">
        ...
        <div class="card-tools pull-right">
          ...
          if (isset($_GET["fechaInical"])) {
             echo '<a href="vistas/modulos/descargar-reporte.php?reporte=reporte&fechaInicial='.$_GET["fechaInical"].'&fechaFinal='.$_GET["fechaFinal"].'">';
          }else {
