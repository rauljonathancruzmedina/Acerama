...
$(".formularioVenta").on("change", "input#nuevoEfectivoVenta", function(){
	...
	var we=nuevoCambioEfectivo.val();

	$("#nuevoCambioVent").val(we);
...
$(".tablaV").on("click", ".btnImprimirticketV", function(){

	var idVenta = $(this).attr("idVenta");
	console.log(idVenta);
	 window.location ="index.php?ruta=imprimirtickt&idVentat="+idVenta;
