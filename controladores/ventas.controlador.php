		...
		foreach ($listaProductosV as $key => $value) {
		 ...
		 $tablaClientes = "clientes";
		  ...
		  $datos = array("id_vendedor" => $_POST["idVendedor"],
						 ...
						 "impuestos" => $_POST["nuevoPrecioDescuento"],
		  ...
		  $respuesta = ModeloVentas::mdlIngresarVenta($tabla, $datos);
 			...
 			if ($respuesta == "ok") {
				...
				$idvent = $_POST["nuevaVenta"];
				echo '<script>
						var idven= "<?php echo $idvent; ?>";
						Swal.fire({
						  title:"¡La venta ha sido guardada correctamente!",
						  icon: "success",
						  showDenyButton: true,
						  confirmButtonText:"imprimir ticket",
						  denyButtonText: "no imprimir ticket",
						}).then((result) => {
						  /* Read more about isConfirmed, isDenied below */
						  if (result.isConfirmed) {
						  
						    window.location = "tickt";
	    ...
	    if (isset($_POST["EditVenta"])) {
				...
				====================================================================*/
					...
					$nuevoStock_2 = ModeloProductos::mdlActualizarProducto($tablaProductos_2, $item1b_2, $valor1b_2, $valor_2);
					 ...
					 $tablaClientes_2 = "clientes";
					  ...
					  $traerCliente_2 = ModeloClientes::ModelMostrarClientes($tablaClientes_2, $item_2, $valorC_2);

					  $item1a_2 = "compras";
					  $valor1a_2 = array_sum($totalProductosComprados) + $traerCliente["compras"];

					  $comprasCliente_2 = ModeloClientes::mdlActualizarClientes($tablaClientes_2, $item1a_2, $valor1a_2, $valorC_2);
					  ...
					  $valor1b_2 = $fecha.' '.$hora; 
						  ...
						  $comprasCliente_2 = ModeloClientes::mdlActualizarClientes($tablaClientes_2, $item1b_2, $valor1b_2, $valorC_2);
				}
		  ...
		  =========================================*/
		 		 ...
		 		 $datos = array("id_vendedor" => $_POST["idEditVendedor"],
								...
								"importe" => $_POST["nuevoEfectivoVenta"]);
	...
	public function ctrDescargarReporte(){
		...
		if (isset($_GET["reporte"])) {
			...
			foreach ($ventas as $row => $item) {
				...
				$cliente = ControladorClientes::controMostrarClientes("id", $item["id_cliente"]);
