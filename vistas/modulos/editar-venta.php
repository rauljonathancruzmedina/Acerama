                      ...
                      <div class="input-group-prepend">
                       ...
                       <select class="form-control select2 select2-danger input-lg" data-dropdown-css-class="select2-danger" id="seleccionarEditCliente" name="seleccionarEditCliente" required>
                        ...
                        <?php 
                          ...
                          $usuariosVend = ControladorClientes::controMostrarClientes($itemVend, $valorVend);
                        ...
                        <div class="row" style="padding:5px 15px">  
                         ...
                         <div class="col-lg-2 col-xs-12 precioCol" >
                           ...
                           <div class="col-lg-1 col-xs-12 cantidadProducto">
                            ...
                            <input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="0.10" step="any" value="'.$value["cantidad"].'" stock="'.$AntiguoStock.'" nuevoStock="'.$stock.'" apartirDe="'.$apartirD.'" required>
              ...
              <div class="row">
                ...
                <div class="col-lg-8 col-xs-12">
                 ...
                 <h4 class="text-center">Comentarios de venta</h4>
                    ...
                    <textarea class="form-control input-lg" rows="3" cols="120" name="Editcomentario" placeholder="Comentarios" id="Editcomentario"><?php echo $ventaE["comentario"]; ?></textarea>
                    ...
                    <tbody>
                      ...
                      <td style="width:50%">
                        ...
                        <div class="input-group">
                          ...
                          <input type="number" class="form-control input-lg" min="0.25" step="any" id="nuevoDescuentoVenta" name="nuevoDescuentoVenta" value="<?php echo $ventaE["impuestos"] ?>" >

                          <input type="hidden" name="nuevoPrecioDescuento" id="nuevoPrecioDescuento" value="<?php echo $ventaE["impuestos"] ?>"required>
