...
$bloque2 = <<<EOF
    ...
    <table  style="font-size:10px; padding:5px 10px;">
        ...
        <tr> 
            ...
            <td style="border: 1px solid #666; background-color:white; width:160px">Vendedor: $nombreUs</td>
...
$neto = $item1["neto"];
$comentario =$item1["comentario"];
$impuestos = $item1["impuestos"];
...
$TotalD = $Cortefin + $DineroCaja;

$TotalDinero = number_format($TotalD,2);
...
$bloque5 = <<<EOF
    ...
    <table style="font-size:10px; padding:5px 10px;">
        ...
        <tr>
            <td style="border: 1px solid #666;  background-color:#7FB9ED; width:135px text-align:center">
             Neto:
            </td>
