                    ...
                    <div class="col-md-6 ">
                       ...
                       <label>Categoría</label>
                          ...
                          <div class="input-group mb-3">
                              ...
                              <option id="editarCategoria" value="'.$categorias["id"].'">'.$categorias["nombre"].'</option>';
                              
                              $item1 = null;
                              $valor1 = null;

                              $categoria = ControladorCategorias::ctrMostrarCategoria($item1, $valor1);
                   ...
                   <!--========================================== 
                    ...
                    ==========================================-->
                      ...
                      if ($productos["imagen"] !="") {
                        ...
                        echo '<img src="'.$productos["imagen"].'" class="img-fuld img-responsive previsualizar" style="max-width:100%;width:400px;height:250px;">';
                        
                          } else {
                        
                        echo '<img src="vistas/img/productos/Recurso.svg" class="img-fuld img-responsive previsualizar" style="max-width:100%;width:400px;height:250px;">';
