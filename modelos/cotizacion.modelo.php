...
class ModeloCotiz{
	...
	EDITAR COTIZACION
	=============================================*/
	static public function mdlEditCotizacion($tabla, $datos){

		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET remitente = :remitente, fecha = :fecha, cliente = :cliente, productos = :productos, comentarios = :comentarios, descuento = :descuento, neto = :neto, total = :total WHERE codigo = :codigo");
